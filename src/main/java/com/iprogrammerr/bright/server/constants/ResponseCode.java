...
public enum ResponseCode {
    ...
    USE_PROXY(305), SWITCH_PROXY(306), TEMPORARY_REDIRECT(307), PERMANENT_REDIRECT(308),
    ...
    REQUEST_TIMEOUT(408), CONFLICT(409), LENGTH_REQUIRED(411), PRECONDITION_FAILED(412), PAYLOAD_TOO_LARGE(413),
    URI_TOO_LONG(414), UNSUPPORTED_MEDIA_TYPE(415), RANGE_NOT_SATISFABLE(416), EXPECTATION_FAILED(417),
    I_AM_A_TEAPOT(418), MISDIRECTED_REQUEST(421), UNPROCESSABLE_ENTITY(422), LOCKED(423), FAILED_DEPENDENCY(424),
    UPGRADE_FAILED(426), PRECONDITION_REQUIRED(428), TOO_MANY_REQUESTS(429), REQUEST_HEADER_FIELDS_TOO_LARGE(431), 
