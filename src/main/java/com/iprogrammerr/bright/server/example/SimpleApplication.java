...
public final class SimpleApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		ConditionalRespondent helloRespondent = new PotentialRespondent("hello/{id:int}", get,
				new HelloRespondent());
		ConditionalRespondent complexRespondent = new PotentialRespondent(
				"complex/{id:long}/search?message=string&scale=float", post,
		...
		ConditionalFilter authorizationSecondFilter = new PotentialFilter(
