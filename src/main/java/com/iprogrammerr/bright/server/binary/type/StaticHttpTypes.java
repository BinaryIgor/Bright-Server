...
public final class StaticHttpTypes implements HttpTypes {
	...
	private static final String[] APPLICATION_TYPES = new String[] { "json", "pdf", "rar", "tar",
			"zip", "sh", "xhtml", "xml", "abw", "csh", "doc", "epub", "jar", "ods", "ogx", "ppt",
			"xls" };
	private static final String[] IMAGE_TYPES = new String[] { "jpg", "png", "gif", "svg", "bmp",
			"ico", "tif", "tiff", "webp" };
